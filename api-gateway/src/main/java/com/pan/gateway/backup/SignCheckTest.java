...
//     private String sign;
//
//     public SignCheckTest(String accessKey, String nonce, long timestamp, String sign) {
...
//     }
//
//     public Mono<Void> isValid() {
//         return checkAccessKey()
//             .filter(valid -> valid && checkNonce()
//                 && checkTimestamp()
//                 && checkSign())
//             .then();
//     }
//
//     private Mono<Boolean> checkAccessKey() {
